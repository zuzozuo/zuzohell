...
MIN_NUMBER_TO_KILL = 12 #HOW MANY SHOULD YOU KILL TO MAKE THE BOSS APPEAR
MAX_NUMBER_TO_KILL = 23

MIN_MOBS_NUMBER = 3 #HOW MANY MOBS AT ONE TIME CAN BE SUMMONED
MAX_MOB_NUMBER = 6
